          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: mediumDefault.copyWith(color: MyColor.getBlackColor(), fontSize: Dimensions.fontLarge),
                ...
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                            ...
                            style: mediumDefault.copyWith(color: MyColor.getDeleteButtonTextColor(), fontSize: Dimensions.fontLarge),
                          ),
                  ),
                ),
              ),
