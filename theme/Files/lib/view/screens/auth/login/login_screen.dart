...
import 'package:ovo_meet/core/helper/shared_preference_helper.dart';
...
import 'package:ovo_meet/environment.dart';
...
import 'package:ovo_meet/view/components/text/default_text.dart';
            ...
            builder: (controller) => SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(MyStrings.signUptoContinue, style: boldOverLarge.copyWith(fontSize: Dimensions.space25)),
                  Text(MyStrings.pleaseLogintoContinue, style: regularDefault.copyWith(color: MyColor.getGreyText())),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                            ...
                            child: const CustomGradiantButton(text: MyStrings.continuewithPhone, hasBorder: true, textColor: MyColor.buttonColor)),
                        const SocialLoginSection(),
                        const SizedBox(height: 35),
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: Dimensions.space50), // Optional: for padding around the content
                          child: Wrap(
