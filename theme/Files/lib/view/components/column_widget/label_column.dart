  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(body.tr,style: lastTextRed?regularDefault.copyWith(fontSize:isSmallFont?Dimensions.fontSmall:Dimensions.fontDefault,color: MyColor.getRedCancelTextColor()):regularDefault.copyWith(fontSize:isSmallFont?Dimensions.fontSmall:Dimensions.fontDefault,),overflow: TextOverflow.ellipsis,)
      ],
    );
  }
}
