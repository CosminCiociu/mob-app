  ...
  Widget build(BuildContext context) {
    return Column(
            ...
            children: [
              Text(
                header.tr,
                style: headerTextStyle ?? regularLarge.copyWith(color: MyColor.colorBlack),
              ...
              isOnlyHeader? const SizedBox.shrink() : Text(
                ...
                style: isDate ? regularDefault.copyWith(fontStyle: FontStyle.italic, color: textColor ?? MyColor.getTextColor(), fontSize: Dimensions.fontSmall) : bodyTextStyle ?? regularSmall.copyWith(color: textColor ??Theme.of(context).textTheme.titleLarge!.color, fontWeight: FontWeight.w500),
                overflow: TextOverflow.ellipsis,
              ),
              SizedBox(
                height: space,
