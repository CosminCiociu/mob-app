...
class RouteHelper {
  ...
  List<GetPage> routes = [
    ...
    GetPage(name: registrationwithEmailScreen, page: () => const EnterRegistrationEmailScreen()),
    ...
    GetPage(name: enterPhNumberScreen, page: () => const EnterPhoneNumberScreen()),
    GetPage(name: registrationwithPhoneScreen, page: () => const EnterPhoneNumberRegistrationScreen()),
    GetPage(name: verificationCodeScreen, page: () => const VerificationCodeScreen()),
    GetPage(name: addProfileDetailsScreen, page: () => const AddProfileDetailsScreen()),
    GetPage(name: selectGenderScreen, page: () => const SelectGenderScreen()),
    GetPage(name: selectIntersetScreen, page: () => const SelectInterstScreen()),
    GetPage(name: idealMatchScreen, page: () => const IdealMatchScreen()),
    GetPage(name: homeScreen, page: () => const HomeScreen()),
    GetPage(name: searchConnectionScreen, page: () => const SearchConnectionScreen()),
    GetPage(name: partnersProfileScreen, page: () => const PartnersProfileScreen()),
    ...
    GetPage(name: termsAndConditionsScreen, page: () => const  TermsAndConditions()),
