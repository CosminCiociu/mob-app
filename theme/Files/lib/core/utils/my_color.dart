...
class MyColor {
  ...
  static const Color buttonColor       = Color(0xffEA4C7B);

  static const Color primaryColor   = Color(0xFFFDF5F7);
  ...
  static Color getColorById(int index) {
    ...
    if (index >= 0 && index < randomColors.length) {
      return Color(int.parse(randomColors[index].substring(1), radix: 16) + 0xFF000000);
    } else {
      return Colors.black;
    }
  }
  ...
  static Color getSubtitleTextColorText() {
    return Get.find<ThemeController>().darkTheme ? MyColor.dSubtitleColor.withOpacity(0.8): MyColor.lSubtitleColor.withOpacity(0.8);
  }

  static Color getCardColor() {
    return Get.find<ThemeController>().darkTheme ? MyColor.dCardColor.withOpacity(0.8): MyColor.colorBlack.withOpacity(0.8);
  }
  ...
  static Color getInputTextColor() {
    return Get.find<ThemeController>().darkTheme ? dInputTextColor: lInputTextColor;
  }
  ...
  static Color getAppBarColor() {
    return Get.find<ThemeController>().darkTheme ? dBackgroundColor: colorWhite;
  }
  ...
  static Color getDividerColor() {
    return Get.find<ThemeController>().darkTheme ? dDividerColor: lDividerColor;
  }
  ...
  static Color getHeadingTextColor() {
    return Get.find<ThemeController>().darkTheme ? dheadingTextColor: primaryTextColor;
  }
  ...
  static const Color currencyBoxColor        = Color(0xff504FB6);
  static const Color goldenColor        = Color(0xBDFFD900);
  ...
  static Color getSecondaryTextColor() {
    return Get.find<ThemeController>().darkTheme ? dSecondaryTextColor: lSecondaryTextColor;
  }
