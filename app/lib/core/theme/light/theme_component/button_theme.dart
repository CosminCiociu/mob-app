...
class MyButtonTheme {
  static ButtonThemeData get lightButtonTheme => ButtonThemeData(
      buttonColor: MyColor.getPrimaryColor(),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)));

  static ButtonThemeData get darkButtonTheme => ButtonThemeData(
      buttonColor: MyColor.getPrimaryColor(),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8)));

  static SegmentedButtonThemeData get lightSegmentButtonTheme =>
      SegmentedButtonThemeData(
          style: ButtonStyle(
        backgroundColor: WidgetStatePropertyAll(MyColor.getPrimaryColor()),
      ));

  static SegmentedButtonThemeData get darkSegmentButtonTheme =>
      SegmentedButtonThemeData(
          style: ButtonStyle(
        backgroundColor: WidgetStatePropertyAll(MyColor.getPrimaryColor()),
      ));
