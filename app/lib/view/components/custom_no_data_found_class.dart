...
import 'package:ovo_meet/view/components/buttons/custom_round_border_shape.dart';
            ...
            Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: widget.isNoInternet? Lottie.asset(MyImages.noInternet,height:  MediaQuery.of(context).size.height*widget.imageHeight,width: MediaQuery.of(context).size.width*.6,):CustomSvgPicture(image:widget.image,height: 100,width: 100,color: MyColor.getIconColor(),),
                ),
                Center(
                    child: Padding(
                    ...
                    children: [
                      Text(
                        ...
                        style:semiBoldDefault.copyWith(
                          color: widget.isNoInternet ? MyColor.getRedColor() : MyColor.getTextColor(),
                      ...
                      }, child: RoundedBorderContainer(text: MyStrings.retry.tr, bgColor: MyColor.getRedColor(),borderColor: MyColor.getRedColor(),textColor: MyColor.getWhiteColor())): const SizedBox()
                    ],
                  ),
                )),
              ],
